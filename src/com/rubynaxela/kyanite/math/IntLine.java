...
public final class IntLine {
     ...
     */
    public IntLine(@NotNull Vector2i point1, @NotNull Vector2i point2) {
        this.point1 = point1;
        this.point2 = point2;
    }
     ...
     */
    public boolean intersects(@NotNull IntLine other) {
        final Vector2f p1 = other.point1.asVector2f(), p2 = other.point2.asVector2f();
        final double det = MathUtils.determinant(Vec2.subtract(point2, point1).asVector2f(), Vec2.subtract(p1, p2)),
                t = MathUtils.determinant(Vec2.subtract(p1, point1), Vec2.subtract(p1, p2)) / det,
                u = MathUtils.determinant(Vec2.subtract(point2, point1).asVector2f(), Vec2.subtract(p1, point1)) / det;

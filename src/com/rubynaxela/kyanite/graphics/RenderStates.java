...
public final class RenderStates {
    ...
    /**
     * Pre-defined instance holding the default render states using {@link BlendMode#ALPHA}
     * blending, the identity transformation and no texture or shader.
     */
    public static final RenderStates DEFAULT = new RenderStates(BlendMode.ALPHA, Transform.IDENTITY, null, null);
    ...
    /**
     * Constructs a new set of render states with default settings and the specified blending mode.
     *
    ...
    /**
     * Constructs a new set of render states with default settings and the specified transformation matrix.
     *
    ...
    /**
     * Constructs a new set of render states with default settings and the specified texture.
     *
    ...
    /**
     * Constructs a new set of render states with default settings and the specified shader.
     *

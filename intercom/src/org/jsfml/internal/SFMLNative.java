...
/**
 * A bridge between {@link com.rubynaxela.kyanite.core.SFMLNative} and the native library loader {@code init()} method.
 *
...
@Deprecated
@Intercom
public abstract class SFMLNative {

    protected SFMLNative() {
    }
